...
public final class VideoProcessor: VideoProcessing, @unchecked Sendable {
    ...
    public func processVideo(file: URL, asset: AVAsset) async throws -> VideoMetadata {
        ...
        //track.load(.estimatedDataRate)
        
        let creationDate = (try? FileManager.default.attributesOfItem(atPath: file.path)[.creationDate] as? Date)?.ISO8601Format()
