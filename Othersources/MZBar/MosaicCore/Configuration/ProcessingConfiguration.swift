...
public struct ProcessingConfiguration: Sendable {
    ...
    public let previewDensity: String
    ...
    ///   - previewDensity: Density of frame extraction for preview
    ...
    ///   - orientation: Orientation of the mosaic
    ///   - useAutoLayout: Whether to use auto layout
    public init(
        width: Int = 5120,
        density: String = "M",
        format: String = "heic",
        ...
        self.previewDensity = previewDensity
