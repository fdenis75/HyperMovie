...
// MARK: - Movie File
@MainActor
class MovieFile: MovieFileProtocol, Hashable {
    let id = UUID()
    let url: URL
    let name: String
...
struct DensityConfig: Equatable, Hashable, Codable {
    ...
    let thumbnailCountDescription: String
    ...
    init(name: String, factor: Double, extractsMultiplier: Double, thumbnailCountDescription: String) {
        self.name = name
        self.factor = factor
    ...
    static let xxl = DensityConfig(name: "XXL", factor: 0.25, extractsMultiplier: 0.25, thumbnailCountDescription: "minimal")
    static let xl = DensityConfig(name: "XL", factor: 0.5, extractsMultiplier: 0.5, thumbnailCountDescription: "low")
    static let l = DensityConfig(name: "L", factor: 0.75, extractsMultiplier: 0.75, thumbnailCountDescription: "medium")
    static let m = DensityConfig(name: "M", factor: 1.0, extractsMultiplier: 1.0, thumbnailCountDescription: "high")        
    static let s = DensityConfig(name: "S", factor: 2.0, extractsMultiplier: 1.5, thumbnailCountDescription: "very high")
    static let xs = DensityConfig(name: "XS", factor: 3.0, extractsMultiplier: 2.0, thumbnailCountDescription: "super high")
    static let xxs = DensityConfig(name: "XXS", factor: 4.0, extractsMultiplier: 3.0, thumbnailCountDescription: "maximal")
    
    static let allCases = [xxl, xl, l, m, s, xs, xxs]
    static let `default` = xs
